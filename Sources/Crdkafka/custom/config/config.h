...
#ifdef __APPLE__
#ifdef __x86_64__
#define BUILT_WITH "STATIC_LINKING GCC GXX PKGCONFIG OSXLD LIBDL PLUGINS ZLIB ZSTD CURL HDRHISTOGRAM SYSLOG SNAPPY SOCKEM OAUTHBEARER_OIDC CRC32C_HW"
#elif defined(__arm64__) || defined(__arm__) || (__aarch64__)
#define BUILT_WITH "STATIC_LINKING GCC GXX PKGCONFIG OSXLD LIBDL PLUGINS ZLIB ZSTD CURL HDRHISTOGRAM SYSLOG SNAPPY SOCKEM OAUTHBEARER_OIDC"
#endif
#elif defined(__linux__)
#ifdef __x86_64__
#define BUILT_WITH "STATIC_LINKING CC CXX PKGCONFIG INSTALL GNULD LIBDL PLUGINS ZLIB SASL_CYRUS ZSTD CURL HDRHISTOGRAM SNAPPY SOCKEM SASL_SCRAM SASL_OAUTHBEARER OAUTHBEARER_OIDC CRC32C_HW"
#elif defined(__arm64__) || defined(__arm__) || defined(__aarch64__)
#define BUILT_WITH "STATIC_LINKING CC CXX INSTALL GNULD LIBDL PLUGINS ZLIB ZSTD CURL HDRHISTOGRAM SNAPPY SOCKEM OAUTHBEARER_OIDC"
#endif
#endif
