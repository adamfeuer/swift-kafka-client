...
#ifdef __APPLE__
#ifdef __x86_64__
#define BUILT_WITH "STATIC_LINKING GCC GXX PKGCONFIG OSXLD LIBDL PLUGINS ZLIB ZSTD HDRHISTOGRAM SYSLOG SNAPPY SOCKEM CRC32C_HW"
#elif defined(__arm64__) || defined(__arm__) || (__aarch64__)
#define BUILT_WITH "STATIC_LINKING GCC GXX PKGCONFIG OSXLD LIBDL PLUGINS ZLIB ZSTD HDRHISTOGRAM SYSLOG SNAPPY SOCKEM "
#endif
#elif defined(__linux__)
#ifdef __x86_64__
#define BUILT_WITH "STATIC_LINKING CC CXX PKGCONFIG INSTALL GNULD LIBDL PLUGINS ZLIB SASL_CYRUS ZSTD HDRHISTOGRAM SNAPPY SOCKEM CRC32C_HW"
#elif defined(__arm64__) || defined(__arm__) || defined(__aarch64__)
#define BUILT_WITH "STATIC_LINKING CC CXX INSTALL GNULD LIBDL PLUGINS ZLIB ZSTD HDRHISTOGRAM SNAPPY SOCKEM "
#endif
#endif
